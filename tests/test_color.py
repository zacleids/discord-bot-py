import sys
import os
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))) # This line is necessary to import the module from the parent directory
...
@pytest.mark.parametrize("args", [
    ["random", "3", "include_inverted:true"],
    ["random", "3", "include_inverted", "true"]
])
