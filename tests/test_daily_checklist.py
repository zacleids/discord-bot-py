...
from daily_checklist import (
    DailyChecklist, DailyChecklistCheck, add_item, format_checklist_response, remove_item, check_item, uncheck_item, list_items, get_checklist_for_date, edit_item, move_item, get_current_day
)
...
def clear_tables_before_each_test():
    ...
    print("Wiping DailyChecklist and DailyChecklistCheck tables...")
...
def test_get_checklist_for_previous_date():
    ...
    item = DailyChecklist.create(user_id=user_id, item="Old Task", sort_order=1, created_at=datetime.datetime.combine(previous_date, datetime.time(12, 0)))
