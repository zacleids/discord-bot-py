...
from shared.eight_ball import eight_ball, tell_me_why
...
async def test_eight_ball_tell_me_why():
    ...
    assert result in ["ain't nothing but a heartache", "ain't nothing but a mistake", "I never want to hear you say\nI want it that way"]
